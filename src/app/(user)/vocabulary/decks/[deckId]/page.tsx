...
export default function DeckDetailPage() {
  ...
  return (
    <main className="bg-[#FAFFF6]">
      <div className="bg-[#FAFFF6] p-8 max-w-5xl mx-auto space-y-8">
        {/* BACK BUTTON */}
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            {deck.description && (
              <p className="text-gray-500 mt-2">{deck.description}</p>
            )}
          </div>

          {vocabularies.length > 0 && (
            <button
              onClick={() => router.push(`/vocabulary/decks/${deckId}/learn`)}
