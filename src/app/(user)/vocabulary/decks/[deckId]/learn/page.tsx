...
export default function LearnPage() {
  ...
  if (loading) {
    return <div className="p-8 max-w-xl mx-auto flex items-center justify-center min-h-[50vh]">
  ...
  if (cards.length === 0) {
    return (
      <div className="p-8 max-w-xl mx-auto text-center space-y-4">
        ...
        <p className="text-gray-500">Add words to this deck first before learning.</p>
        <button
  ...
  if (index >= cards.length) {
    return (
      <div className="p-8 max-w-xl mx-auto text-center space-y-6 min-h-[60vh] flex flex-col items-center justify-center">
        <div className="w-20 h-20 bg-green-100 rounded-full flex items-center justify-center mb-4">
          <CheckCircle2 className="w-10 h-10 text-green-600" />
        </div>
        <h2 className="text-3xl font-bold text-gray-900">All Done!</h2>
        <p className="text-gray-500 text-lg">You have reviewed all cards in this deck.</p>
        <button
          onClick={() => router.push(`/vocabulary/decks/${deckId}`)}
  ...
  return (
    <div className="p-6 max-w-xl mx-auto space-y-8 min-h-[80vh] flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        ...
        <FlashCard card={{ id: card.id, vocabulary: card }} onReview={handleReview} />
      </div>
